...
import galena.blissful.world.recipe.HerbalSalveRecipe;
...
public class BlissfulRecipeTypes {
    ...
    public static List<CraftingRecipe> createSalveRecipes() {
        ...
        return getSalves().<CraftingRecipe>map(pair -> {
                    ...
                    ResourceLocation id = new ResourceLocation(BlissfulConstants.MOD_ID, group + flowerBlock.getDescriptionId());
